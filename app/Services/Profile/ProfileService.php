...
class ProfileService implements ProfileServiceInterface
{
    ...
    public function changePassword(int $userId, string $currentPassword, string $newPassword) : User
    {
        ...
        $this->checkSamePassword($oldPasswordHash, $currentPassword);

        $newPasswordHash = $this->hashService->create($newPassword);
        return $this->profileRepository->changePassword($userId, $newPasswordHash);
    }
    ...
    private function checkSamePassword($oldPasswordHash, $currentPassword)
    {
        if(!$this->hashService->validate($oldPasswordHash, $currentPassword)) {
